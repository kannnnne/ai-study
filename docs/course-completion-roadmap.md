...
| 层级 | 目标 | 用途 | 当前判断 |
| --- | --- | --- | --- |
| P0 | 领导/骨干试看版 | 先证明课程价值和演示效果 | 已具备 |
| P1 | 内部试讲版 | 给小范围同学完整试讲并收集反馈 | 已具备，待实际试讲反馈 |
| P2 | 正式发布版 | 面向更大范围推广，有完整视频、文档、练习和 FAQ | 还差 12 到 18 轮 |

当前主控优先级：P1 内部试讲版已具备，先组织 3 到 5 人内部试讲并收集反馈，再决定 P2 正式发布版打磨范围。
...
| 8 | 试讲包和反馈表 | 已完成 | `docs/internal-pilot-plan.md`、`docs/pilot-feedback-form.md` | 能组织 3 到 5 人小范围试讲 |

P1 内部试讲版已具备。下一步不再继续堆材料，优先组织 3 到 5 人试讲，收集反馈后再决定 P2 正式发布版打磨范围。
...
当前状态：P0 试看版和 P1 内部试讲版已具备。

内部试讲包和反馈表已通过主控验收后：

1. 提交并推送 GitHub。
2. 组织领导 / 技术骨干试看，建议使用第 0 课 + 第 6 课。
3. 组织 3 到 5 人内部试讲，按 `docs/internal-pilot-plan.md` 执行。
4. 收集 `docs/pilot-feedback-form.md`，再决定是否进入 P2 正式发布版打磨。

原因：试讲包把已有课程材料变成可组织、可反馈、可决策的内部试讲活动，是 P1 版本收口所需的最后关键材料。
