...
| P1 | 内部试讲版 | 给小范围同学完整试讲并收集反馈 | 还差 2 到 3 轮 |
...
| 录屏材料 | 第 0、1、2、3、4、5、6 课录屏材料 | `docs/lesson-00-recording-material.md`、`docs/lesson-01-workflow-recording-material.md`、`docs/lesson-02-setup-recording-material.md`、`docs/lesson-03-requirement-analysis-recording-material.md`、`docs/lesson-04-design-review-recording-material.md`、`docs/lesson-05-backend-recording-material.md`、`docs/lesson-06-recording-material.md` |
...
P1 预计还需要 2 到 3 轮。每一轮只处理一个子任务，避免上下文混乱。
...
当前下一轮：第 9 课验收复盘材料子窗口。

第 5 课后端开发材料已通过主控验收后：

1. 更新 `docs/master-task-board.md` 和本路线图。
2. 提交并推送 GitHub。
3. 下一轮优先派发“第 9 课验收复盘材料子窗口”。

原因：后端开发课把设计基线转成可运行服务，是第 6 课联调闭环和第 9 课验收复盘的代码基础。
