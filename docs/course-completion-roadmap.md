...
| P1 | 内部试讲版 | 给小范围同学完整试讲并收集反馈 | 还差 6 到 8 轮 |
...
| 录屏材料 | 第 0 课、第 6 课录屏材料 | `docs/lesson-00-recording-material.md`、`docs/lesson-06-recording-material.md` |
...
| 2 | 环境安装课材料 | 待派发 | `docs/lesson-02-setup-recording-material.md`、安装 FAQ | Windows、macOS、WSL2 路径清楚，网络限制有兜底 |
| 3 | 第 1 课工作流材料 | 待派发 | `docs/lesson-01-workflow-recording-material.md` | 讲清 AI、提示词、上下文、Agent、会话拆分 |
| 4 | 第 3 课需求分析材料 | 待派发 | `docs/lesson-03-requirement-analysis-recording-material.md` | 能从粗需求推到边界、流程和验收标准 |
| 5 | 第 4 课设计评审材料 | 待派发 | `docs/lesson-04-design-review-recording-material.md` | 能讲清架构、数据库、API、设计评审 |
| 6 | 第 5 课后端开发材料 | 待派发 | `docs/lesson-05-backend-recording-material.md` | 能讲清后端实现、测试、异常、日志 |
| 7 | 第 9 课验收复盘材料 | 待派发 | `docs/lesson-09-acceptance-recording-material.md` | 能讲清 AI 验收、人工验收、安全验收 |
| 8 | 试讲包和反馈表 | 待派发 | `docs/internal-pilot-plan.md`、反馈表模板 | 能组织 3 到 5 人小范围试讲 |

P1 预计还需要 6 到 8 轮。每一轮只处理一个子任务，避免上下文混乱。
...
1. 更新 `docs/master-task-board.md`。
2. 提交并推送 GitHub。
3. 下一轮优先派发“环境安装课材料子窗口”。

原因：环境安装是学员能否跟做的最大风险点，应该早于后续讲稿补齐。
